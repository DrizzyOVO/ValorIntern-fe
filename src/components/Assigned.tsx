...
const Assigned = () => {
    ...
    useEffect(() => {
        const getTodos = async () => {
            const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/todo/assigned`, {
            ...
            <div className="flex flex-grow items-center justify-center"> 
                <div className="max-w-full p-8 bg-gray-800 rounded-lg shadow-lg text-gray-200 mt-12 w-11/12 sm:w-96 lg:w-4/12">
                    <div className="flex items-center mb-6">
                        ...
                        <h4 className="font-semibold ml-3 text-lg" style={{fontFamily: 'Cookie', fontSize: "25px", color: 'white'}}>Assigned tasks</h4>
                    </div>
